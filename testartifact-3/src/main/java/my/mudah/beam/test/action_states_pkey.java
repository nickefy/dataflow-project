...
public class action_states_pkey extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -4012199471871701782L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"action_states_pkey\",\"namespace\":\"com.dattran.bottledwater.dbschema.public\",\"fields\":[{\"name\":\"ad_id\",\"type\":[\"null\",\"int\"]},{\"name\":\"action_id\",\"type\":[\"null\",\"int\"]},{\"name\":\"state_id\",\"type\":[\"null\",\"int\"]}]}");
   ...
   */
  public static my.mudah.beam.test.action_states_pkey.Builder newBuilder() {
    return new my.mudah.beam.test.action_states_pkey.Builder();
  }
   ...
   * @return A new action_states_pkey RecordBuilder
   */
  public static my.mudah.beam.test.action_states_pkey.Builder newBuilder(my.mudah.beam.test.action_states_pkey.Builder other) {
    return new my.mudah.beam.test.action_states_pkey.Builder(other);
  }
   ...
   * @return A new action_states_pkey RecordBuilder
   */
  public static my.mudah.beam.test.action_states_pkey.Builder newBuilder(my.mudah.beam.test.action_states_pkey other) {
    return new my.mudah.beam.test.action_states_pkey.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<action_states_pkey>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(my.mudah.beam.test.action_states_pkey.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(my.mudah.beam.test.action_states_pkey other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.ad_id)) {
        this.ad_id = data().deepCopy(fields()[0].schema(), other.ad_id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public my.mudah.beam.test.action_states_pkey.Builder setAdId(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public my.mudah.beam.test.action_states_pkey.Builder clearAdId() {
      ad_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public my.mudah.beam.test.action_states_pkey.Builder setActionId(java.lang.Integer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public my.mudah.beam.test.action_states_pkey.Builder clearActionId() {
      action_id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public my.mudah.beam.test.action_states_pkey.Builder setStateId(java.lang.Integer value) {
